...
@Entity(HbaseUser.COLLECTION_NAME)
public class HbaseUser extends HbaseEntity implements User {
   ...
   public HbaseUser(final User user) {
      super(user.getId());
   ...
   public HbaseUser(HBaseDataDocument doc){
      setGroups(new HashSet<>(doc.getArrayList(GROUPS, String.class)));
   ...
   public Map<String, Object> toMap(){
      ...
      if (getGroups() != null) map.put(GROUPS, getGroups());
      return map;
   }
   ...
   public boolean equals(final Object o) {
      ...
      final HbaseUser morphiaUser = (HbaseUser) o;
