...
//                          HbaseUtils.concatParams(LumeerConst.Collection.ATTRIBUTES, oldName),
//                          HbaseUtils.concatParams(LumeerConst.Collection.ATTRIBUTES, newName))));
//   }
//
//   @Override
...
//      return new HBaseDbDataSort(sort);
//   }
//
//   @Override
